...
namespace Native.App.Export
{
	...
	{	
		...
		{	
			...
			Type appDataType = typeof (AppData);	
			// 注册一个 CQApi 实例	
			AppInfo appInfo = new AppInfo ("cn.mikualpha.livesign", 1, 9, "直播开播提醒", "1.4.8", 1023, "初音未来Alpha", "直播平台开播提醒（斗鱼、Bilibili、Twitch、KingKong等）", authCode);	
			...
			AppData.UnityContainer.RegisterInstance<CQLog> ("cn.mikualpha.livesign", AppData.CQLog);	
