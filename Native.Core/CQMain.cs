...
namespace Native.Core
{
	...
	public class CQMain
	{
		...
		{
            unityContainer.RegisterType<ICQStartup, Event_AppStatus>("酷Q启动事件");
            unityContainer.RegisterType<IAppEnable, Event_AppStatus>("应用已被启用");
            unityContainer.RegisterType<IAppDisable, Event_AppStatus>("应用将被停用");
